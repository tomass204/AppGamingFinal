...
class FavoritoViewModelFactoryTest {
    ...
    private lateinit var factory: FavoritoViewModelFactory
    ...
    @Test
    fun `create debe devolver una instancia de FavoritoViewModel cuando se le pide`() {
        // 2. Act
        val viewModel = factory.create(FavoritoViewModel::class.java)

        // 3. Assert
        viewModel.shouldBeInstanceOf<FavoritoViewModel>()
    }
